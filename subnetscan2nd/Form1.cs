...
namespace subnetscan2nd
{
    public partial class Form1 : Form
    {
            ...
            for (int i = 1; i < 255; i++)
            {
                ...
                if (reply.Status == IPStatus.Success)
                {
                    try 
                     ...
                     catch { MessageBox.Show("Couldnt retrieve hostname for "+subnet+subnetn, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information); }
                 }
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            System.Diagnostics.Process.Start("https://www.informatiquemax.net");
        }
